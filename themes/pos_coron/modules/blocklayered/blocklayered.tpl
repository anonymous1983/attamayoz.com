...
<div id="layered_block_left" class="block">
	<p class="title_block">{l s='Shop By' mod='blocklayered'}</p>
	...
	<div id="layered_ajax_loader" style="display: none;">
		<div id="wraper_ajax" style="position: absolute; top: 0; left: 0; z-index: 999999; background-color: #fff; width: 100%; height: 100%; opacity: 0.7;">
		      <p class="ajax-loadding" style="z-index:999999;position: absolute; top: 200px; left:50%; margin-left: -50px;"><img src="{$img_ps_dir}loader.gif" alt="" /></p>
		</div>	
	</div>
</div>
{else}
