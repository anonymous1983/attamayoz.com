...
<li class="total_balance"> {l s='Votre Solde de Recharge' mod='attamayozcardmodule'} : <span class="total_">{$total_recharge} {$currency->suffix}</span>
<li class="total_balance"> {l s='Votre Solde de Bonnus' mod='attamayozcardmodule'} : <span class="total_">{$bonnus} {$currency->suffix}</span>
